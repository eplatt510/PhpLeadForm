<?php
	if(isset($_POST['formSubmit']))
    {
		...
		if(empty($errorMessage)) 
        {
			...
			//mysqli_select_db($db, "leads");

			$sql = "INSERT INTO leads (lead_id, lead_contact_datetime, lead_company, lead_contact, lead_phone, lead_email, lead_address, lead_description, lead_follow_up, lead_fu_date, lead_setup_online, lead_owner) VALUES ('', 
